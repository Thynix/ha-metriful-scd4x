...
#define ARDUINO_PIN_DEFINITIONS_H
  ...
  */
  ...
  #define S_INT_PIN 12
  /* Also make the following connections:
  pin SDA to MS430 pin SDA
  pin SCL to MS430 pin SCL
  pin GND to MS430 pin GND
  pin 3V3 to MS430 pins VPU and VDD
  MS430 pin VIN is unused

  If a PPD42 particle sensor is used, also connect the following:
  pin USB to PPD42 pin 3
  pin GND to PPD42 pin 1
  pin 4 to MS430 pin PRT

  If an SDS011 particle sensor is used, connect the following:
  pin USB to SDS011 pin "5V"
  pin GND to SDS011 pin "GND"
  SDS011 pin "25um" to MS430 pin PRT
  */
#endif
